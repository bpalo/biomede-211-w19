...
The cell membrane itself has a capacitance of about 1 microFarad per centimeter squared. This is a relatively high capacitance, required in order to store energy across the membrane. The capacitance depermines the time response of voltage across the cell membrane. 
...
\subsection{A classification of medical devices}
\begin{itemize}
